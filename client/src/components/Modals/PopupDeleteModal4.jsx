...
function PopupDeleteModal4({
  ...
  const DropItem = useCallback(async (e) => {
      ...
      const response = await fetch(PreUri + "/reservation/" + no + "/dropitem", {
...
export default React.memo(PopupDeleteModal4);
