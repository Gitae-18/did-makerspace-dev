...
import { MATERIAL_CATEGORY_ITEM } from "../../../store/management";
...
export default function ({  query }) {
    ...
    const getItemList = useCallback(async (pageNumber, searchWord) => {
        ...
        const limitCount = 20;
        let requri = PreUri + '/material/category/?page=' + pageNumber + '&limit=' + limitCount;
    ...
    const onSelectItem = useCallback((e, i) => {
        e.preventDefault();
        dispatch({ type: MATERIAL_CATEGORY_ITEM, target: items.items[i] });
        history(location.pathname + '?edit=6');
            ...
            <div className="content_wrap">
                ...
                <div className="content">
                    ...
                    <div className="table">
                        ...
                        <button className="btn_apply" onClick={() => { history('/management?reg=6') }}>신규 등록</button>
