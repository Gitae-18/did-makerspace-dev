...
export default function MentoringDetailUser(){
      ...
      <ul className="text_wrap" style={{marginTop:'20px'}}>
        ...
        <li>
        ...
        </li> <li>
          {
            ...
            status === 'REJ'?
            <>
            <StyledLabel htmlFor="text12">진행 상황/반려</StyledLabel>
            <textarea rows="3" cols="100" readOnly={true} value={data.reject_content + '\n \n반려 사유를 확인하시고 재신청 부탁드립니다.'} style={{padding:'5px 0px', lineHeight:'20px'}} name="content"/>
            </>
            :
            status === 'RUN'?
            <>
