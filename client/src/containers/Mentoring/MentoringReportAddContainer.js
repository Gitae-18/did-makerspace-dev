...
import { MentoringReportAd } from "../../components/pages/PageSub5";
import Mentoring from "../../components/pages/PageSub5";
import qs from 'qs';
export const MentoringReportAddContainer = (props) =>{
    ...
    const View = authority_level>10 ? MentoringReportAd:MentoringReportAd
    return(
