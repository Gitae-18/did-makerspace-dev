...
import { UMentoringDetail,AMentoringDetail } from "../../components/pages/PageSub5";
import qs from 'qs';
export const MentoringDetailContainer = (props) =>{
    ...
    const View = authority_level<10 ? UMentoringDetail:AMentoringDetail;
    return(
