...
db.MentorApplication      = require('./mentor_application')(sequelize,Sequelize);
...
db.MentorFile                = require('./mentor_attached')(sequelize,Sequelize);
db.MentoringFile             = require('./mentoring_attached')(sequelize,Sequelize);
db.MentoringReportFile       = require('./mentoring_report_attached')(sequelize,Sequelize);
db.Mentoring                 = require('./mentoring')(sequelize,Sequelize);
db.MentoringReport           = require('./mentoring_report')(sequelize,Sequelize);
